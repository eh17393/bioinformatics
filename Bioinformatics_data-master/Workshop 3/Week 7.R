...
##calculate standardised time per pop and per species 
long_spp <-  long_spp %>% 
...
##see range of trajectories for different populations 
ggplot(long_spp, aes(x = standardised_time,
                     y = abundance,
...
##calculate variance explained by random effect 
##variance of random effect divided by sum of random effect variance and residual variance 
9602 / (9602+4447)
...
##look at the model summary:
summary(m_mod2)
##calculate variance explained by these random effects
